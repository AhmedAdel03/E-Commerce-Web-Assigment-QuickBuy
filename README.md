...
Allows editing quantities inside the checkout.
...
ProductsData.js → Contains product data

DeliveryOptions.js → Delivery data

Payment.js → Calculates totals
